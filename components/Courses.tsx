...
interface Video {
    title: string;
    url: string; // Link do video (YouTube embed ou similar)
}

interface Course {
    title: string;
    institution: string; // Subtítulo ou Categoria
    description: string;
    tags: string[];
    videos: Video[];
    completed: boolean;
...
const Courses: React.FC = () => {
    return (
        <section id="cursos" className="py-24 px-4 bg-gray-900 dark:bg-black relative overflow-hidden border-t border-white/5">
            {/* Background Elements */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl md:text-6xl font-extrabold font-montserrat text-white mb-6">
                        Cursos & <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Mentoria</span>
                    </h2>
