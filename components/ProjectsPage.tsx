...
const ProjectsPage: React.FC = () => {
    return (
        <section className="min-h-screen pt-28 pb-20 px-4 bg-[#131314] text-white relative transition-colors duration-500 font-sans">
            <div className="max-w-7xl mx-auto animate-fade-in-up">
                ...
                <div className="space-y-24">
                    {PROJECTS.map((project, index) => (
                        <div key={index} className="group relative bg-[#1e1f20] border border-white/5 rounded-3xl p-8 md:p-12 backdrop-blur-sm hover:border-blue-500/30 transition-all duration-500 shadow-sm">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                                ...
                                <div className="flex gap-3">
                                    <a href={project.link} target="_blank" rel="noreferrer" className="px-6 py-2 rounded-full border border-white/20 hover:bg-white hover:text-black text-white transition-all text-sm font-medium">
                                        Visitar Site
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-black/40 rounded-xl p-6 border border-white/5 transition-colors">
                                ...
                                <div className="relative w-full min-h-[300px] bg-black/60 rounded-2xl border border-white/10 overflow-hidden flex flex-col items-center justify-center group-hover:shadow-[0_0_30px_rgba(0,102,255,0.1)] transition-shadow">
                                    ...
                                    <div className="text-center p-8 relative z-10">
                                        ...
                                        <button className="px-5 py-2 bg-blue-600/10 text-blue-400 border border-blue-500/50 rounded-lg text-xs hover:bg-blue-600 hover:text-white transition-all uppercase font-bold tracking-wider">
                                            Carregar
                                        </button>
                                    </div>
